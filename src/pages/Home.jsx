    ...
    <div className="h-screen w-screen">
      ...
      <div className="w-full h-full">
        <div className="landingPage h-full w-full flex flex-col relative top-[10vh]">
          ...
          <div className="leadingSection w-full px-20 h-full flex gap-10">
            <div className="h-full w-1/2 flex items-center justify-center px-5 relative">
              <div className="Image h-[25rem] w-1/2">
                <img
                  src="/images/b8fae54c91face434e9ea448a875ea3e.png"
                  alt="style"
                  className="rounded-3xl h-full w-full object-cover object-top"
                />
              </div>
              <div className="group1 h-[12rem] w-[14rem] bg-white absolute left-12 top-1/4 shadow-lg rounded-xl flex flex-col">
                ...
                <div className="textgroup flex flex-col items-center justify-center gap-2 h-full w-full">
                  <h1 className="text-3xl self-start p-12 pb-0 leading-none font-bold font-Manrope">
                    40%
                  </h1>
                  <p className="px-5 text-sm font-Manrope">
                    Achieved reduction in project execution time by optimising
                    team availability
                  </p>
                </div>
              </div>
              <div className="group2 h-[5rem] w-[14rem] bg-white absolute left-[15%] top-2/3 rounded-full shadow-lg flex gap-5">
                <div className="svg h-full w-1/3 flex items-center pl-5">
                  <svg
                    width="53"
                    height="53"
                    viewBox="0 0 53 53"
                ...
                <div className="textGroup h-full w-full flex flex-col items-center">
                  <h1 className="self-start font-semibold py-4 pb-0">
                    10 DAYS
                  </h1>
                  <p className="self-start ">Staff Deployment</p>
                </div>
              </div>
              <div className="group3 h-[12rem] w-[14rem] bg-[#002e22] text-white absolute left-1/2 flex flex-col items-start top-2/3 rounded-xl shadow-lg">
                <h1 className="p-5 py-10 text-4xl pb-2 flex items-center justify-between gap-2">
                  $0.5{" "}
                  <span className="text-xl text-[#e2e2e2] self-end font-semibold">
                    MILLION
                  </span>{" "}
                </h1>
                <p className="px-6 self-start pt-0">
            ...
            <div className="secoundSec h-full w-1/2 flex flex-col items-start justify-around px-28 pt-20 pb-0">
              ...
              <button className="btn h-16 flex items-center justify-center gap-2 w-48 bg-black capitalize font-medium rounded-full text-white">
                explore more{" "}
                <span>
                  <svg
                    width="24"
